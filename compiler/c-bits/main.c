...
void print_tuple(int val){
	// FIXME
        //modifications for the print function go here
	//what do we know we have a val which is a number right it has 3 lsb and then rest is what
	int changes = val - 1;
	//printf("%d\n", changes);
	int * ptr = val -1;
	int length = *ptr;
